  ...
  return (
    <>
      <Typography variant="h5" component="div" sx={{ms: 'auto', mb: 3}}>
        Welcome to my Blog. Here in this page I share with motivational quotes
        about success, for work and best motivational quotes to start your day.
      </Typography>
      ...
      <Typography variant="h5" component="div" sx={{ms: 'auto', mb: 3}}>
        ...
        excuses, escape your comfort zone, and take action. Here are some
        motivational quotes from successful business people and public figures,
        past and present.
      </Typography>
      <Typography variant="h5" component="div" sx={{ms: 'auto', mb: 3}}>
        Finding a motivational quote that resonates with you is an energizing
        feeling.
      </Typography>
      <Typography variant="h5" component="div" sx={{ms: 'auto', mb: 3}}>
        Inspirational statements often seem like our own opinions reflected back
        at us—with the added clarity that comes from some of the greatest minds
        in history.
      </Typography>
